...
public class Breweries extends ResourceSupport  implements Serializable {
    ...
    public Breweries(int id, String name, String address1, String address2, String city, String state, String code, String country, String phone, String website, String image, String description, int addUser, Date lastMod, double creditLimit, String email) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "Breweries{" + "id=" + id + ", name=" + name + ", address1=" + address1 + ", address2=" + address2 + ", city=" + city + ", state=" + state + ", code=" + code + ", country=" + country + ", phone=" + phone + ", website=" + website + ", image=" + image + ", description=" + description + ", addUser=" + addUser + ", lastMod=" + lastMod + ", creditLimit=" + creditLimit + ", email=" + email + '}';
    }
