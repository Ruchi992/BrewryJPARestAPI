...
public class Beers implements Serializable {
    ...
    public String toString() {
        return "Beers{" + "id=" + id + ", breweryId=" + breweryId + ", name=" + name + ", catId=" + catId + ", styleId=" + styleId + ", abv=" + abv + ", ibu=" + ibu + ", srm=" + srm + ", description=" + description + ", addUser=" + addUser + ", lastMod=" + lastMod + ", image=" + image + ", buyPrice=" + buyPrice + ", sellPrice=" + sellPrice + '}';
    }
